...
simulated_figS1_A <- plot_p_M_S(A = 0.1, s = 0.5, alpha = 0.05, df = Inf, n.sims = 1000) + labs(title = 'A', x = 'Replication (mean = 0.1, SD = 0.5)')
simulated_figS1_B <- plot_p_M_S(A = 2, s = 0.5, alpha = 0.05, df = Inf, n.sims = 1000) + labs(title = 'B', x = 'Replication (mean = 2, SD = 0.5)')
...
# include stressor category as a fixed effect 
MMA_power.F.M_lnrR.Mtressor <- lmer(power.F.M_lnrr ~ 1 + I(stressor_lnrr) -1 + (1 | studyID_lnrr), data = individual_est_lnrr)
summary(MMA_power.F.M_lnrR.Mtressor)$coefficients
# log
MMA_power.F.M_lnrR.Mtressor2 <- lmer(log(power.F.M_lnrr+ 0.025) ~ 1 + I(stressor_lnrr) -1 + (1 | studyID_lnrr), data = individual_est_lnrr)
# this is median
summary(MMA_power.F.M_lnrR.Mtressor2)$coefficients %>% exp() - 0.025


#---------------------adjusted_lnrr ---------------------#

# include stressor category as a fixed effect 
MMA_power.F.M_adjusted_lnrR.Mtressor <- lmer(power.F.M_adjusted_lnrr ~ 1 + I(stressor_adjusted_lnrr) -1 + (1 | studyID_adjusted_lnrr), data = individual_est_adjusted_lnrr)
summary(MMA_power.F.M_adjusted_lnrR.Mtressor)$coefficients
# log
MMA_power.F.M_adjusted_lnrR.Mtressor2 <- lmer(log(power.F.M_adjusted_lnrr+ 0.025) ~ 1 + I(stressor_adjusted_lnrr) -1 + (1 | studyID_adjusted_lnrr), data = individual_est_adjusted_lnrr)
# this is median
summary(MMA_power.F.M_adjusted_lnrR.Mtressor2)$coefficients %>% exp() - 0.025
...
# include stressor category as a fixed effect 
MMA_power.F.M_RR.Mtressor <- lmer(power.F.M_RR ~ 1 + I(stressor_RR) -1 + (1 | studyID_RR), data = individual_est_RR)
summary(MMA_power.F.M_RR.Mtressor)$coefficients
# log
MMA_power.F.M_RR.Mtressor2 <- lmer(log(power.F.M_RR+ 0.025) ~ 1 + I(stressor_RR) -1 + (1 | studyID_RR), data = individual_est_RR)
# this is median
summary(MMA_power.F.M_RR.Mtressor2)$coefficients %>% exp() - 0.025


#---------------------adjusted_lnRR* ---------------------#

# include stressor category as a fixed effect 
MMA_power.F.M_adjusted_RR.Mtressor <- lmer(power.F.M_adjusted_RR ~ 1 + I(stressor_adjusted_RR) -1 + (1 | studyID_adjusted_RR), data = individual_est_adjusted_RR)
summary(MMA_power.F.M_adjusted_RR.Mtressor)$coefficients
# log
MMA_power.F.M_adjusted_RR.Mtressor2 <- lmer(log(power.F.M_adjusted_RR+ 0.025) ~ 1 + I(stressor_adjusted_RR) -1 + (1 | studyID_adjusted_RR), data = individual_est_adjusted_RR)
# this is median
summary(MMA_power.F.M_adjusted_RR.Mtressor2)$coefficients %>% exp() - 0.025
...
# include stressor category as a fixed effect 
MMA_power.F.M_CVR.Mtressor <- lmer(power.F.M_CVR ~ 1 + I(stressor_CVR) -1 + (1 | studyID_CVR), data = individual_est_CVR)
summary(MMA_power.F.M_CVR.Mtressor)$coefficients
# log
MMA_power.F.M_CVR.Mtressor2 <- lmer(log(power.F.M_CVR+ 0.025) ~ 1 + I(stressor_CVR) -1 + (1 | studyID_CVR), data = individual_est_CVR)
# this is median
summary(MMA_power.F.M_CVR.Mtressor2)$coefficients %>% exp() - 0.025
...
# include stressor category as a fixed effect 
MMA_power.F.M_VR.Mtressor <- lmer(power.F.M_VR ~ 1 + I(stressor_VR) -1 + (1 | studyID_VR), data = individual_est_VR)
summary(MMA_power.F.M_VR.Mtressor)$coefficients
# log
MMA_power.F.M_VR.Mtressor2 <- lmer(log(power.F.M_VR+ 0.025) ~ 1 + I(stressor_VR) -1 + (1 | studyID_VR), data = individual_est_VR)
# this is median
summary(MMA_power.F.M_VR.Mtressor2)$coefficients %>% exp() - 0.025
...
# include stressor category as a fixed effect 
MMA_power.R.M_lnrR.Mtressor <- lmer(power.R.M_lnrr ~ 1 + I(stressor_lnrr) -1 + (1 | studyID_lnrr), data = individual_est_lnrr)
summary(MMA_power.R.M_lnrR.Mtressor)$coefficients
# log
MMA_power.R.M_lnrR.Mtressor2 <- lmer(log(power.R.M_lnrr+ 0.025) ~ 1 + I(stressor_lnrr) -1 + (1 | studyID_lnrr), data = individual_est_lnrr)
# this is median
summary(MMA_power.R.M_lnrR.Mtressor2)$coefficients %>% exp() - 0.025


#---------------------adjusted_lnrr ---------------------#

# include stressor category as a fixed effect 
MMA_power.R.M_adjusted_lnrR.Mtressor <- lmer(power.R.M_adjusted_lnrr ~ 1 + I(stressor_adjusted_lnrr) -1 + (1 | studyID_adjusted_lnrr), data = individual_est_adjusted_lnrr)
summary(MMA_power.R.M_adjusted_lnrR.Mtressor)$coefficients
# log
MMA_power.R.M_adjusted_lnrR.Mtressor2 <- lmer(log(power.R.M_adjusted_lnrr+ 0.025) ~ 1 + I(stressor_adjusted_lnrr) -1 + (1 | studyID_adjusted_lnrr), data = individual_est_adjusted_lnrr)
# this is median
summary(MMA_power.R.M_adjusted_lnrR.Mtressor2)$coefficients %>% exp() - 0.025
...
# include stressor category as a fixed effect 
MMA_power.R.M_RR.Mtressor <- lmer(power.R.M_RR ~ 1 + I(stressor_RR) -1 + (1 | studyID_RR), data = individual_est_RR)
summary(MMA_power.R.M_RR.Mtressor)$coefficients
# log
MMA_power.R.M_RR.Mtressor2 <- lmer(log(power.R.M_RR+ 0.025) ~ 1 + I(stressor_RR) -1 + (1 | studyID_RR), data = individual_est_RR)
# this is median
summary(MMA_power.R.M_RR.Mtressor2)$coefficients %>% exp() - 0.025


#---------------------adjusted_lnRR* ---------------------#

# include stressor category as a fixed effect 
MMA_power.R.M_adjusted_RR.Mtressor <- lmer(power.R.M_adjusted_RR ~ 1 + I(stressor_adjusted_RR) -1 + (1 | studyID_adjusted_RR), data = individual_est_adjusted_RR)
summary(MMA_power.R.M_adjusted_RR.Mtressor)$coefficients
# log
MMA_power.R.M_adjusted_RR.Mtressor2 <- lmer(log(power.R.M_adjusted_RR+ 0.025) ~ 1 + I(stressor_adjusted_RR) -1 + (1 | studyID_adjusted_RR), data = individual_est_adjusted_RR)
# this is median
summary(MMA_power.R.M_adjusted_RR.Mtressor2)$coefficients %>% exp() - 0.025
...
# include stressor category as a fixed effect 
MMA_power.R.M_CVR.Mtressor <- lmer(power.R.M_CVR ~ 1 + I(stressor_CVR) -1 + (1 | studyID_CVR), data = individual_est_CVR)
summary(MMA_power.R.M_CVR.Mtressor)$coefficients
# log
MMA_power.R.M_CVR.Mtressor2 <- lmer(log(power.R.M_CVR+ 0.025) ~ 1 + I(stressor_CVR) -1 + (1 | studyID_CVR), data = individual_est_CVR)
# this is median
summary(MMA_power.R.M_CVR.Mtressor2)$coefficients %>% exp() - 0.025
...
# include stressor category as a fixed effect 
MMA_power.R.M_VR.Mtressor <- lmer(power.R.M_VR ~ 1 + I(stressor_VR) -1 + (1 | studyID_VR), data = individual_est_VR)
summary(MMA_power.R.M_VR.Mtressor)$coefficients
# log
MMA_power.R.M_VR.Mtressor2 <- lmer(log(power.R.M_VR+ 0.025) ~ 1 + I(stressor_VR) -1 + (1 | studyID_VR), data = individual_est_VR)
# this is median
summary(MMA_power.R.M_VR.Mtressor2)$coefficients %>% exp() - 0.025
